...
@Route(value = "admin/ver-proyectos")
public class VerProyectosView extends VerticalLayout {

    private ProyectoService proyectoService;
    private AuthenticatedUser authenticatedUser;
    
    @Autowired
    public VerProyectosView(ProyectoService proyectoService, AuthenticatedUser authenticatedUser) {
        ...
        //El admin tiene acceso a todos los proyectos registrados
